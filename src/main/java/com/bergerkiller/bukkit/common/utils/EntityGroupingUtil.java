...
public class EntityGroupingUtil {
    ...
    public static enum EntityCategory {
        ...
        ANIMAL(true, true, Animals.class, Squid.class, Bat.class, CommonUtil.getClass("org.bukkit.entity.Fish")),
        MONSTER(true, true, Monster.class, Slime.class, Ghast.class, Golem.class),
        NPC(true, true, NPC.class),
        PASSIVE(true, false, Bat.class, Chicken.class, Cow.class, MushroomCow.class, Pig.class, Sheep.class, Squid.class, Villager.class, CommonUtil.getClass("org.bukkit.entity.AbstractVillager"), CommonUtil.getClass("org.bukkit.entity.Fish")),
