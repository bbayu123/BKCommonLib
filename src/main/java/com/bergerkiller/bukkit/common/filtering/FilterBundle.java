 ...
 * element, the {@link #isFiltered(Object)} method will return False. This can
 * be used for multiple conditional filtering requirements.
 *
...
public class FilterBundle<E> implements Filter<E> {
     ...
     * {@link #addFilter(Filter)} method.
     */
    public FilterBundle() {
    }

    /**
     * Constructs a new Filter Bundle using the filters specified. The Filter
     * element types can not be checked, so be sure to only construct a Filter
     * Bundle using Filters that can accept the element type of this filter.
     *
    ...
    /**
     * Adds a Filter to this Filter Bundle. The Filter element types can not be
     * checked, so be sure to only construct a Filter Bundle using Filters that
     * can accept the element type of this filter.
     *
     * @param filter to add
     */
    @SuppressWarnings({"rawtypes", "unchecked"})
    ...
    /**
     * Gets a Collection of all the Filters used by this Filter Bundle. The
